...
func TestGETPlayers(t *testing.T) {
	...
	t.Run("returns Sonia's score", func(t *testing.T) {
		request := newGetScoreRequest("Sonia")
	...
	t.Run("returns Jimo's score", func(t *testing.T) {
		request := newGetScoreRequest("Jimo")
		response := httptest.NewRecorder()
	...
	t.Run("returns 404 on missing players", func(t *testing.T) {
		request := newGetScoreRequest("Luke")
		response := httptest.NewRecorder()
...
func TestGame(t *testing.T) {
	...
	t.Run("start a game with 3 players, send some blind alerts down WS and declare Sonia the winner", func(t *testing.T) {
